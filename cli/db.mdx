...
<ParamField query="--engine / -e" type="string" default="neon">
  Database engine. Currently supported: `neon`.
</ParamField>

<ParamField query="--version / -V" type="number" default="16">
...
<ParamField query="--memory / -m" type="string" default="512M">
  Memory to allocate. Accepted values: `512M`, `1G`, `2G`, `4G`.
</ParamField>

<ParamField query="--disk / -d" type="number" default="1024">
  Disk size for the database volume, expressed in MiB.
</ParamField>

<ParamField query="--settings / -s" type="string[]">
