...
<ParamField query="--app / -a" type="string">
...
<ParamField query="--name / -n" type="string" required>
  Human-readable display name for the volume (e.g. `uploads-prod`).
</ParamField>

<ParamField query="--size / -s" type="number" required>
...
<ParamField query="--app / -a" type="string" required>
...
<ParamField query="--mount / -m" type="string" required>
  Absolute path inside the VM where the volume will be mounted (e.g. `/data`).
</ParamField>

<ParamField query="--mode / -A" type="number" default="0">
...
<ParamField query="--snapshot / -s" type="string" required>
