...
sidebarTitle: "App"
description: "Create, deploy, scale, and manage applications on Mikrom with mikrom app. Control microVM resources, hypervisor selection, and autoscaling from the CLI."
---
