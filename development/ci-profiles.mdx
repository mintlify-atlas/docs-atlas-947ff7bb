---
title: "Dagger-Based CI Profiles for Mikrom Validation"
...
<Steps>
  ...
  <Step title="ci-ceph-tests — Ceph/RBD changes">
    Run only on a host with a live Ceph cluster when you modify `mikrom-agent` RBD code. Pass `MIKROM_RUN_CEPH_TESTS=1`.
  </Step>
