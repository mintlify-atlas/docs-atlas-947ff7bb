---
title: "Quickstart: Deploy Your First App with Mikrom"
sidebarTitle: "Quickstart"
description: "Install Mikrom's CLI, spin up the local development stack, and deploy a containerized app into a microVM in under ten minutes."
---
...
<Steps>
  ...
  <Step title="Retrieve connection details">
    ...
    ```bash
    mikrom db connection <database-id> --output json
    ```
  </Step>
</Steps>
