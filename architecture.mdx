...
description: "A deep-dive into Mikrom's control plane, traffic plane, and platform services — covering request flow, NATS coordination, and per-service responsibilities."
---
